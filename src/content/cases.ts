...
export const cases = [
  {
    ...
    palette: ["var(--brand-light)", "#1f7fb8", "#ffffff"],
  ...
  },
  {
    ...
    description:
      "Placeholder detail copy for the case study page. The final case content can replace this without changing the layout.",
    palette: ["#1f7fb8", "#ffffff", "var(--brand-light)"],
  ...
  },
  {
    ...
    description:
      "Placeholder detail copy for the case study page. The final case content can replace this without changing the layout.",
    palette: ["#ffffff", "var(--brand-light)", "#1f7fb8"],
  ...
  },
  {
    ...
    description:
      "Placeholder detail copy for the case study page. The final case content can replace this without changing the layout.",
    palette: ["var(--brand-light)", "#ffffff", "#1f7fb8"],
  ...
  },
  {
    ...
    description:
      "Placeholder detail copy for the case study page. The final case content can replace this without changing the layout.",
    palette: ["#1f7fb8", "var(--brand-light)", "#ffffff"],
  ...
  },
  {
    ...
    description:
      "Placeholder detail copy for the case study page. The final case content can replace this without changing the layout.",
    palette: ["#ffffff", "#1f7fb8", "var(--brand-light)"],
